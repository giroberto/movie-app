    ...
    <nav class='border-b border-gray-800'>
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16 mt-3 md:mt-0"><a class="hover:text-gray-300" href="">Movies</a></li>
                <li class="md:ml-6 mt-3 md:mt-0"><a class="hover:text-gray-300" href="">Tv Shows</a></li>
                <li class="md:ml-6 mt-3 md:mt-0"><a class="hover:text-gray-300" href="">Actors</a></li>
            </ul>
            <div class="flex flex-col md:flex-row items-center">
                <livewire:search-dropdown>
                    <div class="md:ml-4 mt-3 md:mt-0"><a href="#"><img src="/img/avatar.jpg" alt="avatar"
