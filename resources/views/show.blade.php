...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{ config('services.tmdb.image_url') . '/w500/' . $movie['poster_path'] }}" alt="$movie['title']"
                class="w-64 lg:w-96">
        </div>
        <div class="md:ml-24">
            ...
            <div class="mt-1">
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4">
                        ...
                        <div>
                            @if ($loop->index < 2) <div class="mr-4">{{ $crew['name'] }}</div>
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            @if ($loop->index < 5) <div class="mt-8">
                <a href="#">
                    <img src="{{ config('services.tmdb.image_url') . '/w300/' . $cast['profile_path'] }}"
                        alt="{{$cast['name']}}">
                </a>
                <div class="mt-2">
...
<div class="movie-images" x-data="{ isOpen: false,  image: ''}">
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sd:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($movie['images']['backdrops'] as $image)
            @if ($loop->index < 9) <div class="mt-8">
                <img
                @click="
                    isOpen=true
                    image= '{{ config('services.tmdb.image_url') . '/original' . $image['file_path'] }}'
                "
                    src="{{ config('services.tmdb.image_url') . '/w300/' . $image['file_path'] }}"
                    alt="{{$image['file_path']}}">
        </div>
        @endif
        @endforeach
